...
// List<TelemetryData> tdList =
// fileService.loadTelemetryData("doesNotExist.txt");
// });
...
// // use a test file with no illegal char separators on lines, should load 28
// entries
...
// // use a test file with illegal char separators on 2 lines, should load 26
// entries
// List<TelemetryData> tdList =
// fileService.loadTelemetryData("testDataErrors.txt");
